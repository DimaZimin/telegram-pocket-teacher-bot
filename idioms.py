IDIOMS = [
    ...
    ("Don't count your chickens before the eggs have hatched", "This idiom is used to express "
    ...
    ("Not the sharpest tool in the shed","A gentle way to say that someone is just unintelligent."),
